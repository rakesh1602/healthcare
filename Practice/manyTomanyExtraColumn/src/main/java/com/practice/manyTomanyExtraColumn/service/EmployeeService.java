...
import com.practice.manyTomanyExtraColumn.mapper.EmpDepMapper;
...
public class EmployeeService {
    @Autowired
    private EmpDepMapper empDepMapper;
    ...
    public EmployeeResponse createEmployee(Employee employee) {
        ...
        EmployeeEntity employeeEntity=empDepMapper.modelToEntity(employee);
